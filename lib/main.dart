      ...
      if (faces.isNotEmpty) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Target Face Detected Successfully!')),
          );
        }
      } else {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('No face found in image. Try another.')),
          );
        }
      }
    } catch (e) {
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(
                          color: _staticImageFaces.isNotEmpty ? Colors.green : Colors.red,
                          width: 3
                      ),
                      color: Colors.black,
                    ),
